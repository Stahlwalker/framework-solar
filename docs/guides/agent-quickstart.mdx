...
description: "How an AI agent discovers Solar components via registry.manifest(), mounts them with mountComponent, and self-corrects using ContractError's structured fix field."
---
