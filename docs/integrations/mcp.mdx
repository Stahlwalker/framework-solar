...
description: "solarbuild-mcp exposes your Solar component registry as callable MCP tools. AI agents can discover components, validate props, and self-correct errors at runtime — no static docs required."
---
