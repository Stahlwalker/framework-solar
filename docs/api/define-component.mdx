---
sidebarTitle: "Define Component"
title: "defineComponent: Props, Types, and Slots"
description: "API reference for Solar's defineComponent. Declare prop types, required fields, enum constraints, and slot types to enforce runtime contracts before rendering."
---
...
| `accepts` | string | Only applies to `slot` type. Restricts to a specific component name. |
