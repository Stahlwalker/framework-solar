---
sidebarTitle: "Hooks"
title: "Hooks: State, Async Data, and Lifecycle"
description: "Solar hooks reference: useState, useMemo, useResource, useSubscription, onMount, and onUnmount. All hooks must be called inside a component's render function."
---
...
<ParamField path="handler" type="function" required>
  The event handler. Solar compares this by reference. For a stable handler, define it outside the render function or memoize it with `useMemo`.
</ParamField>
