...
- [x] **"Next steps" block at bottom of Installation:** page currently dead-ends; add links to defineComponent API, Agent Quickstart, and Building a Site
- [x] **Reorganize sidebar by intent:** Getting Started → Guides → API Reference
